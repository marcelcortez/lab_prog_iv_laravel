        ...
        <form action="https://acesso.cesmac.edu.br/abertura" method="POST" onsubmit="">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <label for="inputExame">Exame</label>
                    <select id="inputExame" class="form-control" placeholder="Clínica" required>
                        <option selected hidden>Escolha...</option>
                        <option value="0">Check-Up</option>
                        <option value="1">Ultrasonografia</option>
                        <option value="2">Sangue</option>
                        <option value="3">Urina</option>
